  ...
  .then(Members => {
    ...
    return Event.create([
      ...
      },
      {
        ...
        image:
          'http://mybuyticket.info/wp-content/uploads/2017/05/81106-tap-94037.jpg',
        location: 'https://goo.gl/vqHtQE',
        locationName: 'Brixton O2',
        latlon: '51.465614, -0.114973',
        description:
      ...
      },
      {
        ...
        bandName: 'Enya',
        image:
          'http://leostavern.com/lt01/wp-content/uploads/2016/05/Eithne.jpg',
        location: 'https://goo.gl/xBeqjC',
        locationName: 'XOYO London',
        latlon: '51.525441, -0.085709',
        description:
